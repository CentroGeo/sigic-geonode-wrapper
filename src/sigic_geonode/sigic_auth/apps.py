...
class SigicAuthConfig(AppConfig):
    ...
    def ready(self):
        ...
        print(
            "[geonode_keycloak] OIDC habilitado. Parche get_authenticators() aplicado."
        )
        ...
        print(
            "[geonode_keycloak] OIDC habilitado. Parche get_token_from_auth_header() aplicado."
        )

        import geonode.api.authentication as geonode_api_authentication
        import geonode.base.auth as gba

        geonode_api_authentication.get_token_from_auth_header = (
            gba.get_token_from_auth_header
        )
        ...
        geonode_security_middleware.get_token_from_auth_header = (
            gba.get_token_from_auth_header
        )
