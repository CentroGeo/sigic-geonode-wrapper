            ...
            if complete_metadata is not None:
                ...
                if complete_metadata.lower() == "true":
                    ...
                    queryset = queryset.filter(
                        ...
                        | Q(date_type__in=INCOMPLETE_DATE_TYPE)
                    )
